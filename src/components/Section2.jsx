    ...
    return(
        <div className="container mx-auto p-20">
            <div className="grid grid-cols-2 gap-8">
                ...
                <p className="text-custom-color text-lg mb-2"> 
                I love to workout, cook new foods, and read (I recently got a Kindle!). Right now, I am looking for an internship or full-time position in Front-end development and want to break into ML.</p>
                </div>
